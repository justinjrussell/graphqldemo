...
var mediaType = require("./media");

var ContractType = new graphql.GraphQLObjectType({
    name: 'Contract',
    fields: {
        unique_id:{ type: graphql.GraphQLString },
        id: { type: graphql.GraphQLInt },
        campaign_id:{ type: graphql.GraphQLInt },
        contract_id:{ type: graphql.GraphQLInt },
        name: { type: graphql.GraphQLString },
        campaign_contract_name:{ type: graphql.GraphQLString },
        media_type:{ type: graphql.GraphQLString },
        status_id:{ type: graphql.GraphQLInt },
        status:{ type: graphql.GraphQLString },
        price_format_id:{ type: graphql.GraphQLInt },
        price_format:{ type: graphql.GraphQLString },
        description:{ type: graphql.GraphQLString },
        price:{ type: graphql.GraphQLFloat },
        price_converted:{ type: graphql.GraphQLFloat },
        price_min:{ type: graphql.GraphQLFloat },
        price_min_converted:{ type: graphql.GraphQLFloat },
        price_max:{ type: graphql.GraphQLFloat },
        price_max_converted:{ type: graphql.GraphQLFloat },
        countries:{ type: new graphql.GraphQLList(graphql.GraphQLString) },
        expiration_date:{ type: graphql.GraphQLString },
        restrictions:{ type: graphql.GraphQLString },
        vertical_name:{ type: graphql.GraphQLString },
        media_types:{ type: new graphql.GraphQLList(mediaType) },
        media_type_1:{ type: new graphql.GraphQLList(mediaType) },
        media_type_2:{ type: new graphql.GraphQLList(mediaType) },
        media_type_3:{ type: new graphql.GraphQLList(mediaType) },
        media_type_4:{ type: new graphql.GraphQLList(mediaType) },
        preview_image:{ type: graphql.GraphQLString },
        preview_link:{ type: graphql.GraphQLString },
        currency_id:{ type: graphql.GraphQLInt },
        hidden:{ type: graphql.GraphQLBoolean },
        contract_type_id:{ type: graphql.GraphQLInt },
